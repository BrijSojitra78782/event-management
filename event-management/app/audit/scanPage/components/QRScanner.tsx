 ...
 */
export default function QRScanner({ onSuccess, onFailure }: { onSuccess: () => void, onFailure: () => void }) {

  return (
    <View style={qrScannerStyle.container}>
      <CameraView style={qrScannerStyle.camera} facing='back' onBarcodeScanned={() => { onSuccess() }}>
